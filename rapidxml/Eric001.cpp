...
void IDchecker(int classamount, int i, string IDerror[],string genClass[],string quaClass[],string linkClass[], ofstream& ofs);
...
void checkMuti(bool qulification,char* pNode3name,char* pNode3value, ofstream& ofs)
{
     if (qulification && strcmp(pNode3name,"multiplicity")==0 && strcmp(pNode3value,"[1..*]")==0 )
         {                                  
...
{    
     ...
     IDchecker(classamount,i, IDerror,genClass,quaClass,linkClass,ofs);
